...
SEC("seccomp")
int __always_inline filter_ioctl_KBASE_IOCTL_CS_GET_GLB_IFACE(struct seccomp_data *ctx) {
    int ret = SECCOMP_RET_ALLOW;
    char dev [] = "/dev/mali0";

    if (ctx->nr == 29 && ctx->args[1] == 0xc0188033 && bpf_check_fd(dev, ctx->args[0])) {
        struct syscall_info info = {};
        info.fd = ctx->args[0];

    //arg ptr[inout, kbase_ioctl_cs_get_glb_iface] ptr 0xf8ffa0 8
    //arg kbase_ioctl_cs_get_glb_iface kbase_ioctl_cs_get_glb_iface 0xf8ffa0 24
    	struct kbase_ioctl_cs_get_glb_iface v60;
    	if (bpf_probe_read_sleepable(&v60, sizeof(v60), (void *)ctx->args[2]+0) < 0)
        	return SECCOMP_RET_ERRNO | EINVAL;
    //arg int32 int32 0xf8ffa0 4
    //arg int32 int32 0xf8ffa0 4
    //arg ptr[out, int64] ptr64 0xf8ffa0 8
    //arg int64 int64 0xf8ffa0 8
    	uint64_t v61;
    	if (bpf_probe_read_sleepable(&v61, sizeof(v61), (void *)v60.groups_ptr+0) < 0)
        	return SECCOMP_RET_ERRNO | EINVAL;
    //arg ptr[out, int64] ptr64 0xf8ffa0 8
    //arg int64 int64 0xf8ffa0 8
    	uint64_t v62;
    	if (bpf_probe_read_sleepable(&v62, sizeof(v62), (void *)v60.streams_ptr+0) < 0)
        	return SECCOMP_RET_ERRNO | EINVAL;
    //arg int32 int32 0xf8ffa0 4
    //arg int32 int32 0xf8ffa0 4
    //arg int32 int32 0xf8ffa0 4
    ...
    if (ret != SECCOMP_RET_ALLOW) {;
        bpf_printk("ioctl_KBASE_IOCTL_CS_GET_GLB_IFACE reject\n");
    }
    return ret;
}
